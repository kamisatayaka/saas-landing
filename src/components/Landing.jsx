    ...
    <div className="page">
      ...
      <header className="nav">
        <div className="container nav-inner">
          ...
          <div className="nav-actions">
            ...
            <button onClick={onStart} className="btn btn-primary">Start free</button>
          </div>
        </div>
      </header>
          ...
          <div className="pricing-grid">
            {plans.map((plan) => (
              <div className={`plan ${plan.highlight ? 'plan-hot' : ''}`} key={plan.name}>
                ...
                <button onClick={onStart} className={`btn ${plan.highlight ? 'btn-primary' : 'btn-outline'}`}>
      ...
      <section className="cta">
        <div className="container cta-inner">
          ...
          <button onClick={onStart} className="btn btn-light btn-lg">
            Start free <Arrow />
          </button>
        </div>
      </section>
